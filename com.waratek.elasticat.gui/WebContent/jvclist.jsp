			...
			<div id="sidebar-left" class="span1">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li class="active"><a href="jvclist.html"><i class="fa-icon-list"></i><span class="hidden-tablet"> JVC List</span></a></li>
					</ul>
				</div>
			</div>
						...
						<table class="table table-striped table-bordered table-condensed bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">jvc-1</td>
								<td class="center">
									<span class="label label-success">Running</span>
								</td>
								<td class="center"><span class="sparkLineStats3"></span></td>
								<td class="center">java -cp /tmp foobar</td>
								<td class="center">
									<a class="btn" href="jvcinfo.html">
							...
							<tr>
								<td>2</td>
								<td class="center">0</td>
								<td class="center">jvc-2</td>
								<td class="center">
									<span class="label">Shut Down</span>
								</td>
								<td class="center"><span class="sparkLineStats4"></span></td>
								<td class="center">java -cp /tmp foobar</td>
								<td class="center">
									<a class="btn" href="jvcinfo.html">
										<i class="halflings-icon info-sign"></i>  
							...
							<tr>
								<td>3</td>
								<td class="center">0</td>
								<td class="center">jvc-3</td>
								<td class="center">
									<span class="label label-warning">Paused</span>
								</td>
								<td class="center"><span class="sparkLineStats5"></span></td>
								<td class="center">java -cp /tmp foobar</td>
								<td class="center">
									<a class="btn" href="jvcinfo.html">
										<i class="halflings-icon info-sign"></i>  
							...
							<tr>
								<td>4</td>
								<td class="center">0</td>
								<td class="center">jvc-4</td>
								<td class="center">
									<span class="label label-success">Running</span>
								</td>
								<td class="center"><span class="sparkLineStats6"></span></td>
								<td class="center">java -cp /tmp foobar</td>
								<td class="center">
									<a class="btn" href="jvcinfo.html">
										<i class="halflings-icon info-sign"></i>  
							...
							<tr>
								<td>5</td>
								<td class="center">0</td>
								<td class="center">jvc-5</td>
								<td class="center">
									<span class="label">Shut Down</span>
								</td>
								<td class="center"><span class="sparkLineStats7"></span></td>
								<td class="center">java -cp /tmp foobar</td>
								<td class="center">
									<a class="btn" href="jvcinfo.html">
										<i class="halflings-icon info-sign"></i>  
							...
							<tr>
								<td>6</td>
								<td class="center">0</td>
								<td class="center">jvc-6</td>
								<td class="center">
									<span class="label label-success">Running</span>
								</td>
								<td class="center"><span class="sparkLineStats8"></span></td>
								<td class="center">java -cp /tmp foobar</td>
								<td class="center">
									<a class="btn" href="jvcinfo.html">
										<i class="halflings-icon info-sign"></i>  
